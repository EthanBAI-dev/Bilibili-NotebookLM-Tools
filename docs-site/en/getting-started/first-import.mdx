...
<Steps>
  <Step title="Open a Gemini Notebook notebook">
    Open [Gemini Notebook](https://notebooklm.google.com) in your browser and create or enter a notebook.
  ...
  <Step title="Select a Notebook and import">
    ...
    3. Click the "Import to Gemini Notebook" button
    4. Wait a few seconds — the content will appear in Gemini Notebook's source list
  </Step>
</Steps>

<Tip>
  **Even faster**: Right-click on any web page → "Import to Gemini Notebook" — no need to open the extension panel.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Bilibili Subtitles" icon="play" href="/en/features/bilibili">
    Extract Bilibili video subtitles and import to Gemini Notebook
  </Card>
</CardGroup>
