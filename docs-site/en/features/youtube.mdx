...
description: 'Import YouTube videos, playlists, and channels into Gemini Notebook'
---
...
<Steps>
  ...
  <Step title="Import to Gemini Notebook">
    Click import. The extension sends video URLs to Gemini Notebook in batches, and Gemini Notebook natively parses the content.
  </Step>
</Steps>
...
- Gemini Notebook natively supports YouTube video parsing — the extension only sends video URLs
