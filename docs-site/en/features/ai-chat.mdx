...
description: 'Import Claude, ChatGPT, and Gemini conversations into Gemini Notebook'
---
...
<Steps>
  ...
  <Step title="Import to Gemini Notebook">
    Select your target notebook and click "Import to Gemini Notebook".
  </Step>
</Steps>
...
- Extracted content is imported into Gemini Notebook in Markdown format
