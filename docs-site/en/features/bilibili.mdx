...
description: 'Extract Bilibili video subtitles and import into Gemini Notebook'
---
...
<Steps>
  ...
  <Step title="Import to Gemini Notebook">
    Click "Import to Gemini Notebook" and the selected subtitles appear in Gemini Notebook's source list.
  </Step>
</Steps>
...
<Note>
  Merged mode is ideal for tutorial series — combine multiple videos' subtitles into one document that takes just 1 Gemini Notebook source slot.
</Note>
