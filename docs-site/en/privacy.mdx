...
- **Gemini Notebook**: Sends user-selected URLs to `notebooklm.google.com` to create sources
...
| tabs | Detect supported platforms and locate Gemini Notebook tabs |
| sidePanel | Open the Chrome side panel UI |
| contextMenus | Right-click "Import to Gemini Notebook" menu |
