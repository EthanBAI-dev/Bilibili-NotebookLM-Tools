...
const zh = {
  ...
  'onboarding.prev': '上一步',
  'onboarding.done': '完成',
  'onboarding.stepAccount': '选择你用于 NotebookLM 的 Google 账号，确认当前导入身份，避免导入到错误的笔记。',
  ...
  'onboarding.stepImport': '点击此处将选中内容一键批量导入 NotebookLM，无需切换标签页。',
...
const en: Record<keyof typeof zh, string> = {
  ...
  'onboarding.stepAccount': 'Choose the Google account you use for NotebookLM and confirm you are logged in with the right identity.',
  ...
  'onboarding.stepImport': 'Click here to batch-import your selected content directly into NotebookLM without switching tabs.',
