...
const zh = {
  ...
  'notebook.importToNlm': '一键导入 Gemini Notebook',

  // ── Auth ──
  'auth.verifying': '正在验证身份...',
  'auth.loginTitle': '登录 NoteFlow',
  'auth.loginDesc': '登录后即可使用全部功能，包括导入到 Gemini Notebook',
  ...
  // ── Account Selector ──
  'account.notebooklmAccount': 'Gemini Notebook 账号',
  'account.current': '当前',
  'account.none': '暂无账号',
  ...
  'bilibili.importToNlm': '导入到 Gemini Notebook ({count})',
  ...
  'bilibili.importThis': '导入到 Gemini Notebook',
  ...
  'bilibili.importOneClick': '一键导入 Gemini Notebook',
  ...
  'bilibili.importedSummary': '已导入 {count} 个视频到 Gemini Notebook',
  ...
  'youtube.importToNlm': '导入到 Gemini Notebook ({count})',
  ...
  'onboarding.stepYouTube': '粘贴 YouTube 视频、播放列表或频道链接，批量导入到 Gemini Notebook。',
  ...
  // ── SingleImport ──
  'single.importFailedHint': '导入失败，请确保 Gemini Notebook 页面已打开',
  ...
  'claude.openNotebook': '请先打开 Gemini Notebook 笔记本页面，然后再导入',
  'claude.cannotGetNlmTab': '无法获取 Gemini Notebook 标签页',
  'claude.openNotebookNotHome': '请先打开一个 Gemini Notebook 笔记本（而非首页），然后再导入',
  ...
  'claude.step4': '点击导入到 Gemini Notebook',
  ...
  'claude.guideStep4': '一键导入到 Gemini Notebook，AI 对话秒变知识来源',
  'claude.shareCard': '生成分享卡片',
  'claude.guideTip': '💡 导入前请确保已打开一个 Gemini Notebook 笔记本（非首页）',
  ...
  'bookmark.importToNlm': '导入 Gemini Notebook ({count} 篇)',
  'bookmark.emptyTitle': '收集网页，聚合导入',
  'bookmark.emptyDesc': 'Gemini Notebook 免费用户来源数有限。将多个网页收集后聚合为一份 PDF 导入，用一个来源额度获取多篇内容。',
  'bookmark.step1': '浏览网页时点击上方「收集」按钮，将有价值的页面加入列表',
  'bookmark.step2': '选择多个页面，点击「聚合导出 PDF」合并为一份文档',
  'bookmark.step3': '将 PDF 上传到 Gemini Notebook，一个来源 = 多篇内容',
  'bookmark.pdfSaved': 'PDF 已保存，可上传到 Gemini Notebook 作为来源',
  'web.unsupportedImport': '不支持导入',
  'web.browserWindows': '浏览器窗口',
  'web.listHelpLabel': '查看列表说明',
  'web.listHelpTitle': '此列表用于导入普通网页内容到 Gemini Notebook。',
  'web.listHelpDesc': '已自动排除插件有专用导入入口的网站，例如：哔哩哔哩、YouTube、小宇宙、Apple Podcasts、ChatGPT、Claude、Gemini，以及 Gemini Notebook 页面。',
  ...
  'onboarding.welcomeDesc': '将各种内容一键导入 Gemini Notebook。需要快速了解一下吗？',
  'onboarding.skip': '跳过',
  'onboarding.showMeAround': '开始引导',
  'onboarding.next': '下一步',
  'onboarding.prev': '上一步',
  'onboarding.done': '完成',
  'onboarding.stepAccount': '选择你用于 Gemini Notebook 的 Google 账号，确认当前导入身份，避免导入到错误的笔记。',
  'onboarding.stepActions': '一键切换中英文界面、查看导入历史记录，或打开设置面板进行个性化配置。',
  'onboarding.stepFeaturePanel': '侧边栏根据当前访问的网址自动匹配对应的导入工具——B站、YouTube、播客、网页、AI 对话。',
  'onboarding.stepNotebook': '选择你要导入内容的目标笔记，点击切换其他笔记。',
  'onboarding.stepImport': '点击此处将选中内容一键批量导入 Gemini Notebook，无需切换标签页。',
  ...
  'more.autoRenameDesc': '文本导入后，若 Gemini Notebook 给出 "Pasted Text" 等默认名，自动改成真实标题',
  'more.saving': '保存中...',
  'more.saved': '已保存',
  ...
  'panel.single': '单个',
  'panel.batch': '批量',
  'panel.cannotImportNlm': '不能导入 Gemini Notebook 自身的页面',
  ...
  // ── Runtime / Background ──
  'menu.importPage': '导入此页面到 Gemini Notebook',
  'menu.importLink': '导入此链接到 Gemini Notebook',
  ...
  'runtime.importNotebooklmFailed': '导入 Gemini Notebook 失败',
  ...
  'runtime.bilibiliImportFailedDetail': '导入失败：无法导入到 Gemini Notebook。请确保已在扩展中选择一个笔记本，并已在 Chrome 中登录 notebooklm.google.com',
...
const en: Record<keyof typeof zh, string> = {
  ...
  'app.tabInfoLabel': 'What this tab supports',
  ...
  'notebook.importToNlm': 'Import to Gemini Notebook',

  // ── Auth ──
  'auth.verifying': 'Verifying authentication...',
  'auth.loginTitle': 'Sign in to NoteFlow',
  'auth.loginDesc': 'Sign in to access all features, including importing to Gemini Notebook',
  ...
  // ── Account Selector ──
  'account.notebooklmAccount': 'Gemini Notebook Account',
  ...
  'bilibili.importToNlm': 'Import to Gemini Notebook ({count})',
  ...
  'bilibili.importThis': 'Import to Gemini Notebook',
  ...
  'bilibili.importOneClick': 'Import to Gemini Notebook',
  ...
  'bilibili.importedSummary': 'Imported {count} videos to Gemini Notebook',
  ...
  'youtube.importToNlm': 'Import to Gemini Notebook ({count})',
  ...
  'onboarding.stepYouTube': 'Paste YouTube video, playlist, or channel links to batch import into Gemini Notebook.',
  ...
  // ── SingleImport ──
  'single.importFailedHint': 'Import failed. Make sure Gemini Notebook is open.',
  ...
  'claude.openNotebook': 'Please open a Gemini Notebook notebook first, then import',
  'claude.cannotGetNlmTab': 'Cannot access Gemini Notebook tab',
  'claude.openNotebookNotHome': 'Please open a Gemini Notebook notebook (not the home page), then import',
  ...
  'claude.step4': 'Import to Gemini Notebook',
  ...
  'claude.guideStep4': 'Import to Gemini Notebook — turn AI chats into knowledge sources',
  'claude.shareCard': 'Share Card',
  'claude.guideTip': '💡 Make sure a Gemini Notebook notebook (not homepage) is open before importing',
  ...
  'bookmark.importToNlm': 'Import to Gemini Notebook ({count})',
  'bookmark.emptyTitle': 'Collect pages, import together',
  'bookmark.emptyDesc': 'Gemini Notebook free users have limited sources. Collect multiple pages and export as one PDF to save source slots.',
  'bookmark.step1': 'Click "Collect" above to save valuable pages',
  'bookmark.step2': 'Select multiple pages, click "Export PDF" to merge',
  'bookmark.step3': 'Upload PDF to Gemini Notebook: one source = multiple pages',
  'bookmark.pdfSaved': 'PDF saved. Upload to Gemini Notebook as a source.',
  'web.unsupportedImport': 'Unsupported',
  'web.browserWindows': 'Browser Windows',
  'web.listHelpLabel': 'View list help',
  'web.listHelpTitle': 'This list is used to import regular web content into Gemini Notebook.',
  'web.listHelpDesc': 'Sites with dedicated import flows are excluded automatically, including Bilibili, YouTube, Xiaoyuzhou, Apple Podcasts, ChatGPT, Claude, Gemini, and Gemini Notebook pages.',
  ...
  'onboarding.welcomeDesc': 'Import content from anywhere into Gemini Notebook. Want a quick tour?',
  'onboarding.skip': 'Skip',
  'onboarding.showMeAround': 'Show Me Around',
  'onboarding.next': 'Next',
  'onboarding.prev': 'Previous',
  'onboarding.done': 'Done',
  'onboarding.stepAccount': 'Choose the Google account you use for Gemini Notebook and confirm you are logged in with the right identity.',
  'onboarding.stepActions': 'Switch between Chinese and English, view import history, or open the settings panel to customize your experience.',
  'onboarding.stepFeaturePanel': 'The side panel auto-detects the current website and matches the right import tool — Bilibili, YouTube, podcasts, web pages, or AI chats.',
  'onboarding.stepNotebook': 'Select the target Notebook you want to import into, or switch to another one.',
  'onboarding.stepImport': 'Click here to batch-import your selected content directly into Gemini Notebook without switching tabs.',
  ...
  'more.autoRenameDesc': 'When Gemini Notebook leaves a pasted source as "Pasted Text", automatically rename it to the real title',
  'more.saving': 'Saving...',
  'more.saved': 'Saved',
  ...
  'panel.single': 'Single',
  'panel.batch': 'Batch',
  'panel.cannotImportNlm': 'Cannot import Gemini Notebook pages',
  ...
  // ── Runtime / Background ──
  'menu.importPage': 'Import this page to Gemini Notebook',
  'menu.importLink': 'Import this link to Gemini Notebook',
  ...
  'runtime.importNotebooklmFailed': 'Failed to import to Gemini Notebook',
  ...
  'runtime.bilibiliImportFailedDetail': 'Import failed: unable to import into Gemini Notebook. Make sure you selected a notebook in the extension and are signed in to notebooklm.google.com in Chrome.',
